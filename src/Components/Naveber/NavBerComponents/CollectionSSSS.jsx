...
const CollectionSSSS =()=>{
    const {setCollections} = useContext(myContext)
    ...
    return(
        <>
            <div onMouseLeave={()=>{setCollections(false)}}  
        onMouseEnter={()=> setCollections(true) } 
        className={top ? 'hidden lg:flex xl:w-[85%] xl:mx-[7.5%] h-[60vh] w-full absolute bg-[#F8F7F5] left-0 top-[68px] z-[50]' : 'hidden h-[65vh] lg:flex xl:w-[85%] xl:mx-[7.5%] w-full absolute bg-[#F8F7F5] left-0 top-[114px] z-[50]'}>
            <div className='w-full h-full'>
            <div className='text-sm m-7 '>
                <div className='text-xl font-semibold text-[#126CBA] mb-[7px]'>
                <h1>Trade Show & Events</h1>
                </div>
